...
var fbToForm = function fbToForm (key, sel) {
    var config = config || {
        apiKey:<AIzaSyA8R-r4VWN20atdwbsKa7MlBh8XmcHMy_0>,
        authDomain: <gamersmeet-b785a.firebaseapp.com>,
        databaseURL: <https://gamersmeet-b785a.firebaseio.com>,
        storageBucket: <gamersmeet-b785a.appspot.com>,
    };
